...
public class DateUtil {
	...
	/**
	 * Obtiene los años de una fecha , Libreria que se usa es jodatime
	 * @param startLocalDate
	 * @param endLocalDate
	 * @return year
	 */
    public static int differenceYear(LocalDate startLocalDate,LocalDate endLocalDate){

    	DateTime startTime = new DateTime(startLocalDate.getYear(),startLocalDate.getMonthValue(),startLocalDate.getDayOfMonth(), 0, 0, 0, 0);
    	DateTime endTime = new DateTime(endLocalDate.getYear(), endLocalDate.getMonthValue(), endLocalDate.getDayOfMonth(), 0, 0, 0, 0);
